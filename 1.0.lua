...
if(mode() == 'load') then
   LmodMessage("nBrent lab rnaseq_pipeline is loaded!\n\tPleasesee https://gitlab.com/brentlab/rnaseq_pipe/-/wikis/home for usage instructions.\n")
end
...
prepent_path("PATH", pathJoin(base, "tools"))
