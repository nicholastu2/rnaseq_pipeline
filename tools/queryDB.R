...
writeSummary <- function(query, qname, output){
  ...
  selectQ <- query %>% select(genotype, treatment, strain, inductionDelay, libraryDate, harvestDate, replicate, runNumber, index1Sequence, index2Sequence, fastqFileName, timePoint, floodmedia)
  # print(selectQ)
